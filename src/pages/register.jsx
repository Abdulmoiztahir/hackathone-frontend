      ...
      <div className="flex flex-col items-center justify-center min-h-screen bg-gray-100 overflow-hidden">
        <div className="w-full max-w-md p-8 bg-white rounded-2xl shadow-xl z-10">
          ...
          <form onSubmit={handleRegister}>
            ...
            <button
              type="submit"
              className="w-full py-3 px-4 bg-black text-white font-semibold rounded-lg shadow-lg hover:bg-black focus:outline-none focus:ring-2 focus:ring-blue-400"
            >
              Sign up
            </button>
          </form>
